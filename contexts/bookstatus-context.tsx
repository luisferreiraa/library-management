...
export type SortOption<T = BookStatus> = {
    value: keyof T
    direction: "asc" | "desc"
}
...
interface BookStatusesContextType {
    ...
    totalPages: number
    sortOption: SortOption<BookStatus> | null
    setSortOption: (option: SortOption<BookStatus>) => void
...
export function BookStatusesProvider({
    ...
    const [sortOption, setSortOption] = useState<SortOption<BookStatus> | null>(null)
    ...
    const filteredBookStatuses = useMemo(() => {
        ...
        return result
    }, [searchTerm, optimisticBookStatuses, sortOption, activeFilter])     // Dependências: recalcula apenas quando uma delas mudar
