...
// Modificar a interface para usar BookWithRelations em vez de BookType
...
// Modificar a interface para não receber books separadamente
interface PublisherBooksProps {
    publisher: PublisherWithBooks
    books: BookWithRelations[]
}

// E então atualizar a função para usar publisher.books
export function PublisherBooks({ publisher, books }: PublisherBooksProps) {
