...
interface CreateLanguageBookModalProps {
    open: boolean
...
export function CreateLanguageBookModal({
    open,
    onOpenChange,
    languageId,
    languageName,
}: CreateLanguageBookModalProps) {
    ...
    const form = useForm<FormValues>({
        ...
        defaultValues: {
            ...
            coverImage: "",
            formatId: "",
            languageId: languageId,     // Pré-preencher com ID do idioma
            publisherId: "",
            authorId: "",
            translatorId: "",
            bookStatusId: "",
    ...
    useEffect(() => {
        if (open) {
            const loadRelatedData = async () => {
                try {
                    const [authorsData, formatsData, translatorsData, categoriesData, publishersData, bookStatusesData] =
                        await Promise.all([
                            getAuthors(),
                            getFormats(),
                            getTranslators(),
    ...
    async function onSubmit(values: FormValues) {
        ...
        try {
            ...
            addBook({
                ...
                language: { id: languageId, name: languageName },
    ...
    return (
        <Dialog open={open} onOpenChange={onOpenChange}>
            <DialogContent className="sm:max-w-[800px]">
                <DialogHeader>
                    <DialogTitle>Adicionar Novo Livro para {languageName}</DialogTitle>
                                    ...
                                    <FormField
                                        ...
                                        render={({ field }) => (
                                            <FormItem>
                                                ...
                                                <Select disabled value={languageId}>
                                                    <FormControl>
                                                        <SelectTrigger>
