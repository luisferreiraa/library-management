...
import { LanguageWithBooks } from "@/lib/languages"
import { CreateLanguageBookModal } from "./create-language-book-modal"

interface LanguageBooksProps {
    language: LanguageWithBooks
}

export function LanguageBooks({ language }: LanguageBooksProps) {
    const [isAddingBook, setIsAddingBook] = useState(false)
    const books = language.books
        ...
        return (
            <>
                <EmptyState
                    ...
                    description="Este idioma ainda não possui livros registrados."
                    action={
